...
const WORK_COUNT = { 莓华: 0, 御园莓华: 4, 御園莓華: 30, 莓華: 10, 御園いちか: 6, 白色相簿2: 10 };
const RELATED_FOR = { 莓华: ['御園莓華', '莓華', '御园莓华'], 莓華: ['御園莓華'] };
...
(async () => {
  ...
  if (ok1 && ok2 && ok3 && ok4) { console.log('PASS'); } else { console.error('FAIL'); process.exit(1); }
